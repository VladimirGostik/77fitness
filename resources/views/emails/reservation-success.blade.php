...
<body>
    ...
    <ul>
        ...
        <li><b>Dátum:</b> {{ $reservation->date }}</li>
        <li><b>Čas:</b> {{ $reservation->start_time }}</li>
        <li><b>Miesto:</b> {{ $reservation->location }}</li>
        <li><b>Cena tréningu:</b> {{ $reservation->trainer->session_price }} €</li>
    </ul>

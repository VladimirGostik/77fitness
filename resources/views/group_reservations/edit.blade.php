...
<div class="container mt-5">
  <h1 class="text-white text-center mb-4">Edit Group Reservation</h1>
  <a href="/reservations" class="btn btn-outline-secondary mb-4 btn-md">Go back</a>
        ...
        <div class="card-body p-4">
          <form id="updateGroupReservationForm" action="{{ route('group_reservations.update', ['group_reservation' => $groupReservation->id]) }}" method="POST">
            ...
            <div class="form-group mb-3">
              <label for="start_time" class="form-label h5">Start Time:</label>
            ...
            <div class="form-group mb-3">
              <label for="end_time" class="form-label h5">End Time:</label>
            ...
            <div class="form-group mb-3">
              <label for="max_participants" class="form-label h5">Max Participants:</label>
            ...
            <div class="form-group mb-3">
              <label for="room_id" class="form-label h5">Room:</label>
    ...
    <div class="col-md-6">
      <div class="card bg-dark text-white shadow-lg border-0 rounded-lg p-4">
        @if ($groupReservation->participants->count() > 0)
          <h4 class="mb-3 h5">Registered Participants</h4>
          <ul class="list-group">
        ...
        @else
          <p class="text-white">No participants registered yet.</p>
        @endif

        <h5 class="mt-4 h5">Add Participant</h5>
          ...
          <form action="{{ route('group_reservations.add_participant', $groupReservation->id) }}" method="POST">
            ...
            <div class="form-group mb-3">
              <div class="input-group">
                <select class="form-select form-control-sm" aria-label="Add Participant" name="participant_id" id="participant_id" required>
                ...
                <a href="{{ route('group_reservations.download_pdf', $groupReservation->id) }}" class="btn btn-primary ms-2 btn-sm">Download PDF</a>
              </div>
            </div>

            <button type="submit" class="btn btn-success btn-block btn-md">Add Participant</button>
          </form>
        @else
